	...
	m_CameraPosition(DEFAULT_SPAWN)
{
...

	{
		...
		//glBufferData(GL_DRAW_INDIRECT_BUFFER, TOTAL_CHUNKS * sizeof(DrawArraysIndirectCommand), m_Cmd.data(), GL_STATIC_DRAW);
	...
	//	m_Cmd[i].count = 6 * 6;
	//	m_Cmd[i].instanceCount = CHUNK_WIDTH * CHUNK_WIDTH;
	//	m_Cmd[i].first = 0;
